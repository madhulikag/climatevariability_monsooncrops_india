#Fig6&S9 
#Different sensitivity of crops to ENSO and IOD
#Yield Anomalies across 5 cereals for Irrigated and Rainfed districts during ENSO and IOD
...
y_ir <- ggplot()+
  ...
  theme(axis.text=element_text(size=11), axis.title=element_text(size=14, face="bold"), axis.text.x = element_text(vjust=0.6, angle=45))+
...
Harv_Irr_Yield$RI.RI <- ifelse(Harv_Irr_Yield$RICE.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA), NA, 1)
Harv_Irr_Yield_RI <- subset(Harv_Irr_Yield, RI.RI==1)

Harv_Irr_Yield_RI$RI.MZ <- ifelse((Harv_Irr_Yield_RI$RICE.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Yield_RI$MAIZE.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Yield_RI$RI.SGK <- ifelse((Harv_Irr_Yield_RI$RICE.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Yield_RI$KHARIF.SORGHUM.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Yield_RI$RI.PM <- ifelse((Harv_Irr_Yield_RI$RICE.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Yield_RI$PEARL.MILLET.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Yield_RI$RI.FM <- ifelse((Harv_Irr_Yield_RI$RICE.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Yield_RI$FINGER.MILLET.YIELD..Kg.per.ha. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Overlapping_yield <- ggplot()+
  ...
  theme_classic()+
  scale_fill_brewer(palette = "Spectral")+
  theme(axis.text=element_text(size=14), axis.title=element_text(size=14, face="bold"), axis.text.x = element_text(vjust=0.6, angle=45))+
...
Harv_Irr_Prod$RI.RI <- ifelse(Harv_Irr_Prod$RICE.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA), NA, 1)
Harv_Irr_Prod_RI <- subset(Harv_Irr_Prod, RI.RI==1)

Harv_Irr_Prod_RI$RI.MZ <- ifelse((Harv_Irr_Prod_RI$RICE.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Prod_RI$MAIZE.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Prod_RI$RI.SGK <- ifelse((Harv_Irr_Prod_RI$RICE.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Prod_RI$KHARIF.SORGHUM.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Prod_RI$RI.PM <- ifelse((Harv_Irr_Prod_RI$RICE.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Prod_RI$PEARL.MILLET.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Prod_RI$RI.FM <- ifelse((Harv_Irr_Prod_RI$RICE.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Prod_RI$FINGER.MILLET.PRODUCTION..1000.tons. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Area$RI.RI <- ifelse(Harv_Irr_Area$RICE.AREA..1000.ha. %in% c(-1, 0, 0.00, NA), NA, 1)
Harv_Irr_Area_RI <- subset(Harv_Irr_Area, RI.RI==1)

Harv_Irr_Area_RI$RI.MZ <- ifelse((Harv_Irr_Area_RI$RICE.AREA..1000.ha. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Area_RI$MAIZE.AREA..1000.ha. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Area_RI$RI.SGK <- ifelse((Harv_Irr_Area_RI$RICE.AREA..1000.ha. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Area_RI$KHARIF.SORGHUM.AREA..1000.ha. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Area_RI$RI.PM <- ifelse((Harv_Irr_Area_RI$RICE.AREA..1000.ha. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Area_RI$PEARL.MILLET.AREA..1000.ha. %in% c(-1, 0, 0.00, NA)), NA, 1)
...
Harv_Irr_Area_RI$RI.FM <- ifelse((Harv_Irr_Area_RI$RICE.AREA..1000.ha. %in% c(-1, 0, 0.00, NA)) | (Harv_Irr_Area_RI$FINGER.MILLET.AREA..1000.ha. %in% c(-1, 0, 0.00, NA)), NA, 1)
