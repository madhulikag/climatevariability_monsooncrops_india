...
# Spatial differences in percent yield impacts during ENSO and IOD
...
el_nino_data_rice <- Harv_Irr_Yield %>%
  ...
  dplyr::filter(!(RICE.YIELD..Kg.per.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(RiceAnom = mean(RiceAnom, na.rm = TRUE), RicePerAnom = mean(RicePerAnom, na.rm = TRUE)) 

el_nino_data_maize <- Harv_Irr_Yield %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(MAIZE.YIELD..Kg.per.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(MaizeAnom = mean(MaizeAnom, na.rm = TRUE), MaizePerAnom = mean(MaizePerAnom, na.rm = TRUE)) 

el_nino_data_sorghum <- Harv_Irr_Yield %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(KHARIF.SORGHUM.YIELD..Kg.per.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(SorghumKharifAnom = mean(SorghumKharifAnom, na.rm = TRUE), SorghumPerAnom = mean(SorghumPerAnom, na.rm = TRUE)) 

el_nino_data_pearl_millet <- Harv_Irr_Yield %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(PEARL.MILLET.YIELD..Kg.per.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(PearlMilletAnom = mean(PearlMilletAnom, na.rm = TRUE), PearlMilletPerAnom = mean(PearlMilletPerAnom, na.rm = TRUE))

el_nino_data_finger_millet <- Harv_Irr_Yield %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(FINGER.MILLET.YIELD..Kg.per.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(FingerMilletAnom = mean(FingerMilletAnom, na.rm = TRUE), FingerMilletPerAnom = mean(FingerMilletPerAnom, na.rm = TRUE))
...
hist(el_nino_data_rice$RicePerAnom, main = "El Nino - Rice Anomaly", xlab = "Anomaly Value")
hist(la_nina_data_rice$RicePerAnom, main = "La Nina - Rice Anomaly", xlab = "Anomaly Value")
hist(iod_plus_data_rice$RicePerAnom, main = "IOD+ - Rice Anomaly", xlab = "Anomaly Value")
hist(iod_minus_data_rice$RicePerAnom, main = "IOD- - Rice Anomaly", xlab = "Anomaly Value")
hist(el_nino_iod_plus_data_rice$RicePerAnom, main = "El Nino & IOD+ - Rice Anomaly", xlab = "Anomaly Value")
hist(la_nina_iod_minus_data_rice$RicePerAnom, main = "La Nina & IOD- - Rice Anomaly", xlab = "Anomaly Value")

hist(el_nino_data_maize$MaizePerAnom, main = "El Nino - Maize Anomaly", xlab = "Anomaly Value")
hist(la_nina_data_maize$MaizePerAnom, main = "La Nina - Maize Anomaly", xlab = "Anomaly Value")
hist(iod_plus_data_maize$MaizePerAnom, main = "IOD+ - Maize Anomaly", xlab = "Anomaly Value")
hist(iod_minus_data_maize$MaizePerAnom, main = "IOD- - Maize Anomaly", xlab = "Anomaly Value")
hist(el_nino_iod_plus_data_maize$MaizePerAnom, main = "El Nino & IOD+ - Maize Anomaly", xlab = "Anomaly Value")
hist(la_nina_iod_minus_data_maize$MaizePerAnom, main = "La Nina & IOD- - Maize Anomaly", xlab = "Anomaly Value")

hist(el_nino_data_sorghum$SorghumPerAnom, main = "El Nino - SorghumKharif Anomaly", xlab = "Anomaly Value")
hist(la_nina_data_sorghum$SorghumPerAnom, main = "La Nina - SorghumKharif Anomaly", xlab = "Anomaly Value")
hist(iod_plus_data_sorghum$SorghumPerAnom, main = "IOD+ - SorghumKharif Anomaly", xlab = "Anomaly Value")
hist(iod_minus_data_sorghum$SorghumPerAnom, main = "IOD- - SorghumKharif Anomaly", xlab = "Anomaly Value")
hist(el_nino_iod_plus_data_sorghum$SorghumPerAnom, main = "El Nino & IOD+ - SorghumKharif Anomaly", xlab = "Anomaly Value")
hist(la_nina_iod_minus_data_sorghum$SorghumPerAnom, main = "La Nina & IOD- - SorghumKharif Anomaly", xlab = "Anomaly Value")

hist(el_nino_data_pearl_millet$PearlMilletPerAnom, main = "El Nino - PearlMillet Anomaly", xlab = "Anomaly Value")
hist(la_nina_data_pearl_millet$PearlMilletPerAnom, main = "La Nina - PearlMillet Anomaly", xlab = "Anomaly Value")
hist(iod_plus_data_pearl_millet$PearlMilletPerAnom, main = "IOD+ - PearlMillet Anomaly", xlab = "Anomaly Value")
hist(iod_minus_data_pearl_millet$PearlMilletPerAnom, main = "IOD- - PearlMillet Anomaly", xlab = "Anomaly Value")
hist(el_nino_iod_plus_data_pearl_millet$PearlMilletPerAnom, main = "El Nino & IOD+ - PearlMillet Anomaly", xlab = "Anomaly Value")
hist(la_nina_iod_minus_data_pearl_millet$PearlMilletPerAnom, main = "La Nina & IOD- - PearlMillet Anomaly", xlab = "Anomaly Value")

hist(el_nino_data_finger_millet$FingerMilletPerAnom, main = "El Nino - FingerMillet Anomaly", xlab = "Anomaly Value")
hist(la_nina_data_finger_millet$FingerMilletPerAnom, main = "La Nina - FingerMillet Anomaly", xlab = "Anomaly Value")
hist(iod_plus_data_finger_millet$FingerMilletPerAnom, main = "IOD+ - FingerMillet Anomaly", xlab = "Anomaly Value")
hist(iod_minus_data_finger_millet$FingerMilletPerAnom, main = "IOD- - FingerMillet Anomaly", xlab = "Anomaly Value")
hist(el_nino_iod_plus_data_finger_millet$FingerMilletPerAnom, main = "El Nino & IOD+ - FingerMillet Anomaly", xlab = "Anomaly Value")
hist(la_nina_iod_minus_data_finger_millet$FingerMilletPerAnom, main = "La Nina & IOD- - FingerMillet Anomaly", xlab = "Anomaly Value")

#el_nino_mean

# For Rice Crop Anomaly
rice_lt_0 <- sum(el_nino_data_rice$RicePerAnom < 0, na.rm = TRUE)
rice_gt_0 <- sum(el_nino_data_rice$RicePerAnom > 0, na.rm = TRUE)
cat("% Rice Anomaly < 0:", rice_lt_0, "\n")
cat("% Rice Anomaly > 0:", rice_gt_0, "\n")

# For Maize Crop Anomaly
maize_lt_0 <- sum(el_nino_data_maize$MaizePerAnom < 0, na.rm = TRUE)
maize_gt_0 <- sum(el_nino_data_maize$MaizePerAnom > 0, na.rm = TRUE)
cat("% Maize Anomaly < 0:", maize_lt_0, "\n")
cat("% Maize Anomaly > 0:", maize_gt_0, "\n")

# For SorghumKharif Crop Anomaly
sorghum_lt_0 <- sum(el_nino_data_sorghum$SorghumPerAnom < 0, na.rm = TRUE)
sorghum_gt_0 <- sum(el_nino_data_sorghum$SorghumPerAnom > 0, na.rm = TRUE)
cat("% SorghumKharif Anomaly < 0:", sorghum_lt_0, "\n")
cat("% SorghumKharif Anomaly > 0:", sorghum_gt_0, "\n")

# For PearlMillet Crop Anomaly
pearl_millet_lt_0 <- sum(el_nino_data_pearl_millet$PearlMilletPerAnom < 0, na.rm = TRUE)
pearl_millet_gt_0 <- sum(el_nino_data_pearl_millet$PearlMilletPerAnom > 0, na.rm = TRUE)
cat("% PearlMillet Anomaly < 0:", pearl_millet_lt_0, "\n")
cat("% PearlMillet Anomaly > 0:", pearl_millet_gt_0, "\n")

# For FingerMillet Crop Anomaly
finger_millet_lt_0 <- sum(el_nino_data_finger_millet$FingerMilletPerAnom < 0, na.rm = TRUE)
finger_millet_gt_0 <- sum(el_nino_data_finger_millet$FingerMilletPerAnom > 0, na.rm = TRUE)
cat("% FingerMillet Anomaly < 0:", finger_millet_lt_0, "\n")
cat("% FingerMillet Anomaly > 0:", finger_millet_gt_0, "\n")
...
# For Rice Crop Anomaly
rice_lt_0 <- sum(la_nina_data_rice$RicePerAnom < 0, na.rm = TRUE)
rice_gt_0 <- sum(la_nina_data_rice$RicePerAnom > 0, na.rm = TRUE)
cat("% Rice Anomaly < 0:", rice_lt_0, "\n")
cat("% Rice Anomaly > 0:", rice_gt_0, "\n")

# For Maize Crop Anomaly
maize_lt_0 <- sum(la_nina_data_maize$MaizePerAnom < 0, na.rm = TRUE)
maize_gt_0 <- sum(la_nina_data_maize$MaizePerAnom > 0, na.rm = TRUE)
cat("% Maize Anomaly < 0:", maize_lt_0, "\n")
cat("% Maize Anomaly > 0:", maize_gt_0, "\n")

# For SorghumKharif Crop Anomaly
sorghum_lt_0 <- sum(la_nina_data_sorghum$SorghumPerAnom < 0, na.rm = TRUE)
sorghum_gt_0 <- sum(la_nina_data_sorghum$SorghumPerAnom > 0, na.rm = TRUE)
cat("% SorghumKharif Anomaly < 0:", sorghum_lt_0, "\n")
cat("% SorghumKharif Anomaly > 0:", sorghum_gt_0, "\n")

# For PearlMillet Crop Anomaly
pearl_millet_lt_0 <- sum(la_nina_data_pearl_millet$PearlMilletPerAnom < 0, na.rm = TRUE)
pearl_millet_gt_0 <- sum(la_nina_data_pearl_millet$PearlMilletPerAnom > 0, na.rm = TRUE)
cat("% PearlMillet Anomaly < 0:", pearl_millet_lt_0, "\n")
cat("% PearlMillet Anomaly > 0:", pearl_millet_gt_0, "\n")

# For FingerMillet Crop Anomaly
finger_millet_lt_0 <- sum(la_nina_data_finger_millet$FingerMilletPerAnom < 0, na.rm = TRUE)
finger_millet_gt_0 <- sum(la_nina_data_finger_millet$FingerMilletPerAnom > 0, na.rm = TRUE)
cat("% FingerMillet Anomaly < 0:", finger_millet_lt_0, "\n")
cat("% FingerMillet Anomaly > 0:", finger_millet_gt_0, "\n")
...
# For Rice Crop Anomaly
rice_lt_0 <- sum(iod_plus_data_rice$RicePerAnom < 0, na.rm = TRUE)
rice_gt_0 <- sum(iod_plus_data_rice$RicePerAnom > 0, na.rm = TRUE)
cat("% Rice Anomaly < 0:", rice_lt_0, "\n")
cat("% Rice Anomaly > 0:", rice_gt_0, "\n")

# For Maize Crop Anomaly
maize_lt_0 <- sum(iod_plus_data_maize$MaizePerAnom < 0, na.rm = TRUE)
maize_gt_0 <- sum(iod_plus_data_maize$MaizePerAnom > 0, na.rm = TRUE)
cat("% Maize Anomaly < 0:", maize_lt_0, "\n")
cat("% Maize Anomaly > 0:", maize_gt_0, "\n")

# For SorghumKharif Crop Anomaly
sorghum_lt_0 <- sum(iod_plus_data_sorghum$SorghumPerAnom < 0, na.rm = TRUE)
sorghum_gt_0 <- sum(iod_plus_data_sorghum$SorghumPerAnom > 0, na.rm = TRUE)
cat("% SorghumKharif Anomaly < 0:", sorghum_lt_0, "\n")
cat("% SorghumKharif Anomaly > 0:", sorghum_gt_0, "\n")

# For PearlMillet Crop Anomaly
pearl_millet_lt_0 <- sum(iod_plus_data_pearl_millet$PearlMilletPerAnom < 0, na.rm = TRUE)
pearl_millet_gt_0 <- sum(iod_plus_data_pearl_millet$PearlMilletPerAnom > 0, na.rm = TRUE)
cat("% PearlMillet Anomaly < 0:", pearl_millet_lt_0, "\n")
cat("% PearlMillet Anomaly > 0:", pearl_millet_gt_0, "\n")

# For FingerMillet Crop Anomaly
finger_millet_lt_0 <- sum(iod_plus_data_finger_millet$FingerMilletPerAnom < 0, na.rm = TRUE)
finger_millet_gt_0 <- sum(iod_plus_data_finger_millet$FingerMilletPerAnom > 0, na.rm = TRUE)
cat("% FingerMillet Anomaly < 0:", finger_millet_lt_0, "\n")
cat("% FingerMillet Anomaly > 0:", finger_millet_gt_0, "\n")
...
# For Rice Crop Anomaly
rice_lt_0 <- sum(iod_minus_data_rice$RicePerAnom < 0, na.rm = TRUE)
rice_gt_0 <- sum(iod_minus_data_rice$RicePerAnom > 0, na.rm = TRUE)
cat("% Rice Anomaly < 0:", rice_lt_0, "\n")
cat("% Rice Anomaly > 0:", rice_gt_0, "\n")

# For Maize Crop Anomaly
maize_lt_0 <- sum(iod_minus_data_maize$MaizePerAnom < 0, na.rm = TRUE)
maize_gt_0 <- sum(iod_minus_data_maize$MaizePerAnom > 0, na.rm = TRUE)
cat("% Maize Anomaly < 0:", maize_lt_0, "\n")
cat("% Maize Anomaly > 0:", maize_gt_0, "\n")

# For SorghumKharif Crop Anomaly
sorghum_lt_0 <- sum(iod_minus_data_sorghum$SorghumPerAnom < 0, na.rm = TRUE)
sorghum_gt_0 <- sum(iod_minus_data_sorghum$SorghumPerAnom > 0, na.rm = TRUE)
cat("% SorghumKharif Anomaly < 0:", sorghum_lt_0, "\n")
cat("% SorghumKharif Anomaly > 0:", sorghum_gt_0, "\n")

# For PearlMillet Crop Anomaly
pearl_millet_lt_0 <- sum(iod_minus_data_pearl_millet$PearlMilletPerAnom < 0, na.rm = TRUE)
pearl_millet_gt_0 <- sum(iod_minus_data_pearl_millet$PearlMilletPerAnom > 0, na.rm = TRUE)
cat("% PearlMillet Anomaly < 0:", pearl_millet_lt_0, "\n")
cat("% PearlMillet Anomaly > 0:", pearl_millet_gt_0, "\n")

# For FingerMillet Crop Anomaly
finger_millet_lt_0 <- sum(iod_minus_data_finger_millet$FingerMilletPerAnom < 0, na.rm = TRUE)
finger_millet_gt_0 <- sum(iod_minus_data_finger_millet$FingerMilletPerAnom > 0, na.rm = TRUE)
cat("% FingerMillet Anomaly < 0:", finger_millet_lt_0, "\n")
cat("% FingerMillet Anomaly > 0:", finger_millet_gt_0, "\n")
...
# For Rice Crop Anomaly
rice_lt_0 <- sum(el_nino_iod_plus_data_rice$RicePerAnom < 0, na.rm = TRUE)
rice_gt_0 <- sum(el_nino_iod_plus_data_rice$RicePerAnom > 0, na.rm = TRUE)
cat("% Rice Anomaly < 0:", rice_lt_0, "\n")
cat("% Rice Anomaly > 0:", rice_gt_0, "\n")

# For Maize Crop Anomaly
maize_lt_0 <- sum(el_nino_iod_plus_data_maize$MaizePerAnom < 0, na.rm = TRUE)
maize_gt_0 <- sum(el_nino_iod_plus_data_maize$MaizePerAnom > 0, na.rm = TRUE)
cat("% Maize Anomaly < 0:", maize_lt_0, "\n")
cat("% Maize Anomaly > 0:", maize_gt_0, "\n")

# For SorghumKharif Crop Anomaly
sorghum_lt_0 <- sum(el_nino_iod_plus_data_sorghum$SorghumPerAnom < 0, na.rm = TRUE)
sorghum_gt_0 <- sum(el_nino_iod_plus_data_sorghum$SorghumPerAnom > 0, na.rm = TRUE)
cat("% SorghumKharif Anomaly < 0:", sorghum_lt_0, "\n")
cat("% SorghumKharif Anomaly > 0:", sorghum_gt_0, "\n")

# For PearlMillet Crop Anomaly
pearl_millet_lt_0 <- sum(el_nino_iod_plus_data_pearl_millet$PearlMilletPerAnom < 0, na.rm = TRUE)
pearl_millet_gt_0 <- sum(el_nino_iod_plus_data_pearl_millet$PearlMilletPerAnom > 0, na.rm = TRUE)
cat("% PearlMillet Anomaly < 0:", pearl_millet_lt_0, "\n")
cat("% PearlMillet Anomaly > 0:", pearl_millet_gt_0, "\n")

# For FingerMillet Crop Anomaly
finger_millet_lt_0 <- sum(el_nino_iod_plus_data_finger_millet$FingerMilletPerAnom < 0, na.rm = TRUE)
finger_millet_gt_0 <- sum(el_nino_iod_plus_data_finger_millet$FingerMilletPerAnom > 0, na.rm = TRUE)
cat("% FingerMillet Anomaly < 0:", finger_millet_lt_0, "\n")
cat("% FingerMillet Anomaly > 0:", finger_millet_gt_0, "\n")
...
# For Rice Crop Anomaly
rice_lt_0 <- sum(la_nina_iod_minus_data_rice$RicePerAnom < 0, na.rm = TRUE)
rice_gt_0 <- sum(la_nina_iod_minus_data_rice$RicePerAnom > 0, na.rm = TRUE)
cat("% Rice Anomaly < 0:", rice_lt_0, "\n")
cat("% Rice Anomaly > 0:", rice_gt_0, "\n")

# For Maize Crop Anomaly
maize_lt_0 <- sum(la_nina_iod_minus_data_maize$MaizePerAnom < 0, na.rm = TRUE)
maize_gt_0 <- sum(la_nina_iod_minus_data_maize$MaizePerAnom > 0, na.rm = TRUE)
cat("% Maize Anomaly < 0:", maize_lt_0, "\n")
cat("% Maize Anomaly > 0:", maize_gt_0, "\n")

# For SorghumKharif Crop Anomaly
sorghum_lt_0 <- sum(la_nina_iod_minus_data_sorghum$SorghumPerAnom < 0, na.rm = TRUE)
sorghum_gt_0 <- sum(la_nina_iod_minus_data_sorghum$SorghumPerAnom > 0, na.rm = TRUE)
cat("% SorghumKharif Anomaly < 0:", sorghum_lt_0, "\n")
cat("% SorghumKharif Anomaly > 0:", sorghum_gt_0, "\n")

# For PearlMillet Crop Anomaly
pearl_millet_lt_0 <- sum(la_nina_iod_minus_data_pearl_millet$PearlMilletPerAnom < 0, na.rm = TRUE)
pearl_millet_gt_0 <- sum(la_nina_iod_minus_data_pearl_millet$PearlMilletPerAnom > 0, na.rm = TRUE)
cat("% PearlMillet Anomaly < 0:", pearl_millet_lt_0, "\n")
cat("% PearlMillet Anomaly > 0:", pearl_millet_gt_0, "\n")

# For FingerMillet Crop Anomaly
finger_millet_lt_0 <- sum(la_nina_iod_minus_data_finger_millet$FingerMilletPerAnom < 0, na.rm = TRUE)
finger_millet_gt_0 <- sum(la_nina_iod_minus_data_finger_millet$FingerMilletPerAnom > 0, na.rm = TRUE)
cat("% FingerMillet Anomaly < 0:", finger_millet_lt_0, "\n")
cat("% FingerMillet Anomaly > 0:", finger_millet_gt_0, "\n")

el_nino_data_rice$RicePerAnom[which(el_nino_data_rice$RicePerAnom > 20)] <- 20
el_nino_data_rice$RicePerAnom[which(el_nino_data_rice$RicePerAnom < -20)] <- -20

el_nino_data_maize$MaizePerAnom[which(el_nino_data_maize$MaizePerAnom > 20)] <- 20
el_nino_data_maize$MaizePerAnom[which(el_nino_data_maize$MaizePerAnom < -20)] <- -20

el_nino_data_sorghum$SorghumPerAnom[which(el_nino_data_sorghum$SorghumPerAnom > 20)] <- 20
el_nino_data_sorghum$SorghumPerAnom[which(el_nino_data_sorghum$SorghumPerAnom < -20)] <- -20

el_nino_data_pearl_millet$PearlMilletPerAnom[which(el_nino_data_pearl_millet$PearlMilletPerAnom > 20)] <- 20
el_nino_data_pearl_millet$PearlMilletPerAnom[which(el_nino_data_pearl_millet$PearlMilletPerAnom < -20)] <- -20

el_nino_data_finger_millet$FingerMilletPerAnom[which(el_nino_data_finger_millet$FingerMilletPerAnom > 20)] <- 20
el_nino_data_finger_millet$FingerMilletPerAnom[which(el_nino_data_finger_millet$FingerMilletPerAnom < -20)] <- -20

la_nina_data_rice$RicePerAnom[which(la_nina_data_rice$RicePerAnom > 20)] <- 20
la_nina_data_rice$RicePerAnom[which(la_nina_data_rice$RicePerAnom < -20)] <- -20

la_nina_data_maize$MaizePerAnom[which(la_nina_data_maize$MaizePerAnom > 20)] <- 20
la_nina_data_maize$MaizePerAnom[which(la_nina_data_maize$MaizePerAnom < -20)] <- -20

la_nina_data_sorghum$SorghumPerAnom[which(la_nina_data_sorghum$SorghumPerAnom > 20)] <- 20
la_nina_data_sorghum$SorghumPerAnom[which(la_nina_data_sorghum$SorghumPerAnom < -20)] <- -20

la_nina_data_pearl_millet$PearlMilletPerAnom[which(la_nina_data_pearl_millet$PearlMilletPerAnom > 20)] <- 20
la_nina_data_pearl_millet$PearlMilletPerAnom[which(la_nina_data_pearl_millet$PearlMilletPerAnom < -20)] <- -20

la_nina_data_finger_millet$FingerMilletPerAnom[which(la_nina_data_finger_millet$FingerMilletPerAnom > 20)] <- 20
la_nina_data_finger_millet$FingerMilletPerAnom[which(la_nina_data_finger_millet$FingerMilletPerAnom < -20)] <- -20

iod_plus_data_rice$RicePerAnom[which(iod_plus_data_rice$RicePerAnom > 20)] <- 20
iod_plus_data_rice$RicePerAnom[which(iod_plus_data_rice$RicePerAnom < -20)] <- -20

iod_plus_data_maize$MaizePerAnom[which(iod_plus_data_maize$MaizePerAnom > 20)] <- 20
iod_plus_data_maize$MaizePerAnom[which(iod_plus_data_maize$MaizePerAnom < -20)] <- -20

iod_plus_data_sorghum$SorghumPerAnom[which(iod_plus_data_sorghum$SorghumPerAnom > 20)] <- 20
iod_plus_data_sorghum$SorghumPerAnom[which(iod_plus_data_sorghum$SorghumPerAnom < -20)] <- -20

iod_plus_data_pearl_millet$PearlMilletPerAnom[which(iod_plus_data_pearl_millet$PearlMilletPerAnom > 20)] <- 20
iod_plus_data_pearl_millet$PearlMilletPerAnom[which(iod_plus_data_pearl_millet$PearlMilletPerAnom < -20)] <- -20

iod_plus_data_finger_millet$FingerMilletPerAnom[which(iod_plus_data_finger_millet$FingerMilletPerAnom > 20)] <- 20
iod_plus_data_finger_millet$FingerMilletPerAnom[which(iod_plus_data_finger_millet$FingerMilletPerAnom < -20)] <- -20

iod_minus_data_rice$RicePerAnom[which(iod_minus_data_rice$RicePerAnom > 20)] <- 20
iod_minus_data_rice$RicePerAnom[which(iod_minus_data_rice$RicePerAnom < -20)] <- -20

iod_minus_data_maize$MaizePerAnom[which(iod_minus_data_maize$MaizePerAnom > 20)] <- 20
iod_minus_data_maize$MaizePerAnom[which(iod_minus_data_maize$MaizePerAnom < -20)] <- -20

iod_minus_data_sorghum$SorghumPerAnom[which(iod_minus_data_sorghum$SorghumPerAnom > 20)] <- 20
iod_minus_data_sorghum$SorghumPerAnom[which(iod_minus_data_sorghum$SorghumPerAnom < -20)] <- -20

iod_minus_data_pearl_millet$PearlMilletPerAnom[which(iod_minus_data_pearl_millet$PearlMilletPerAnom > 20)] <- 20
iod_minus_data_pearl_millet$PearlMilletPerAnom[which(iod_minus_data_pearl_millet$PearlMilletPerAnom < -20)] <- -20

iod_minus_data_finger_millet$FingerMilletPerAnom[which(iod_minus_data_finger_millet$FingerMilletPerAnom > 20)] <- 20
iod_minus_data_finger_millet$FingerMilletPerAnom[which(iod_minus_data_finger_millet$FingerMilletPerAnom < -20)] <- -20

el_nino_iod_plus_data_rice$RicePerAnom[which(el_nino_iod_plus_data_rice$RicePerAnom > 20)] <- 20
el_nino_iod_plus_data_rice$RicePerAnom[which(el_nino_iod_plus_data_rice$RicePerAnom < -20)] <- -20

el_nino_iod_plus_data_maize$MaizePerAnom[which(el_nino_iod_plus_data_maize$MaizePerAnom > 20)] <- 20
el_nino_iod_plus_data_maize$MaizePerAnom[which(el_nino_iod_plus_data_maize$MaizePerAnom < -20)] <- -20

el_nino_iod_plus_data_sorghum$SorghumPerAnom[which(el_nino_iod_plus_data_sorghum$SorghumPerAnom > 20)] <- 20
el_nino_iod_plus_data_sorghum$SorghumPerAnom[which(el_nino_iod_plus_data_sorghum$SorghumPerAnom < -20)] <- -20

el_nino_iod_plus_data_pearl_millet$PearlMilletPerAnom[which(el_nino_iod_plus_data_pearl_millet$PearlMilletPerAnom > 20)] <- 20
el_nino_iod_plus_data_pearl_millet$PearlMilletPerAnom[which(el_nino_iod_plus_data_pearl_millet$PearlMilletPerAnom < -20)] <- -20

el_nino_iod_plus_data_finger_millet$FingerMilletPerAnom[which(el_nino_iod_plus_data_finger_millet$FingerMilletPerAnom > 20)] <- 20
el_nino_iod_plus_data_finger_millet$FingerMilletPerAnom[which(el_nino_iod_plus_data_finger_millet$FingerMilletPerAnom < -20)] <- -20

la_nina_iod_minus_data_rice$RicePerAnom[which(la_nina_iod_minus_data_rice$RicePerAnom > 20)] <- 20
la_nina_iod_minus_data_rice$RicePerAnom[which(la_nina_iod_minus_data_rice$RicePerAnom < -20)] <- -20

la_nina_iod_minus_data_maize$MaizePerAnom[which(la_nina_iod_minus_data_maize$MaizePerAnom > 20)] <- 20
la_nina_iod_minus_data_maize$MaizePerAnom[which(la_nina_iod_minus_data_maize$MaizePerAnom < -20)] <- -20

la_nina_iod_minus_data_sorghum$SorghumPerAnom[which(la_nina_iod_minus_data_sorghum$SorghumPerAnom > 20)] <- 20
la_nina_iod_minus_data_sorghum$SorghumPerAnom[which(la_nina_iod_minus_data_sorghum$SorghumPerAnom < -20)] <- -20

la_nina_iod_minus_data_pearl_millet$PearlMilletPerAnom[which(la_nina_iod_minus_data_pearl_millet$PearlMilletPerAnom > 20)] <- 20
la_nina_iod_minus_data_pearl_millet$PearlMilletPerAnom[which(la_nina_iod_minus_data_pearl_millet$PearlMilletPerAnom < -20)] <- -20

la_nina_iod_minus_data_finger_millet$FingerMilletPerAnom[which(la_nina_iod_minus_data_finger_millet$FingerMilletPerAnom > 20)] <- 20
la_nina_iod_minus_data_finger_millet$FingerMilletPerAnom[which(la_nina_iod_minus_data_finger_millet$FingerMilletPerAnom < -20)] <- -20
...
gg <- ggplot(el_nino_map_data_rice) +
  geom_sf(aes(fill=RicePerAnom)) +
  scale_fill_gradient2(low = "red", mid = "white", high = "navyblue", midpoint = 0, limit = c(-20,20), breaks = c(-20,-15,-10,-5,0,5,10,15,20), space = "Lab")+
  ggtitle("El Nino Rice Yield Anom")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  theme_void()

gg <- ggplot(el_nino_map_data_maize) +
  geom_sf(aes(fill=MaizePerAnom)) +
  scale_fill_gradient2(low = "red", mid = "white", high = "navyblue", midpoint = 0, limit = c(-20,20), breaks = c(-20,-15,-10,-5,0,5,10,15,20), space = "Lab")+
  ggtitle("El Nino Maize Yield Anom")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  theme_void()
...
gg <- ggplot(el_nino_map_data_sorghum) +
  geom_sf(aes(fill=SorghumPerAnom)) +
  scale_fill_gradient2(low = "red", mid = "white", high = "navyblue", midpoint = 0, limit = c(-20,20), breaks = c(-20,-15,-10,-5,0,5,10,15,20), space = "Lab")+
  ggtitle("El Nino Sorghum Yield Anom")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  theme_void()
...
gg <- ggplot(el_nino_map_data_pearl_millet) +
  geom_sf(aes(fill=PearlMilletPerAnom)) +
  scale_fill_gradient2(low = "red", mid = "white", high = "navyblue", midpoint = 0, limit = c(-20,20), breaks = c(-20,-15,-10,-5,0,5,10,15,20), space = "Lab")+
  ggtitle("El Nino Pearl Millet Yield Anom")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  theme_void()
...
gg <- ggplot(el_nino_map_data_finger_millet) +
  geom_sf(aes(fill=FingerMilletPerAnom)) +
  scale_fill_gradient2(low = "red", mid = "white", high = "navyblue", midpoint = 0, limit = c(-20,20), breaks = c(-20,-15,-10,-5,0,5,10,15,20), space = "Lab")+
  ggtitle("El Nino Finger Millet Yield Anom")+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  theme_void()
...
el_nino_data_rice <- Harv_Irr_Area %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(RICE.AREA..1000.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(RiceAnom = mean(RiceAnom, na.rm = TRUE))

el_nino_data_maize <- Harv_Irr_Area %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(MAIZE.AREA..1000.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(MaizeAnom = mean(MaizeAnom, na.rm = TRUE))

el_nino_data_sorghum <- Harv_Irr_Area %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(KHARIF.SORGHUM.AREA..1000.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(SorghumKharifAnom = mean(SorghumKharifAnom, na.rm = TRUE))

el_nino_data_pearl_millet <- Harv_Irr_Area %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(PEARL.MILLET.AREA..1000.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(PearlMilletAnom = mean(PearlMilletAnom, na.rm = TRUE))

el_nino_data_finger_millet <- Harv_Irr_Area %>%
  dplyr::filter(Year %in% el_nino_years) %>%
  dplyr::filter(!(FINGER.MILLET.AREA..1000.ha. %in% c(NA, -1))) %>%
  dplyr::group_by(Dist.Code) %>%
  dplyr::summarise(FingerMilletAnom = mean(FingerMilletAnom, na.rm = TRUE))
